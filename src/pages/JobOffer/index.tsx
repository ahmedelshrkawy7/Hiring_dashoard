...
import AddEditModalEdit from './Modal/AddEditModalEdit'
import { useTranslation } from "react-i18next";


function JobOffer() {
  // debuggerJob Offer
  const allServiceUser = createCrudService<any>('job-offer')
  ...
  const [isAddEditModalOpenEdit, setIsAddEditOpenEdit] = useState(false)
  ...
  return (
    <>
      <AddEditModal
        initialData={modalType === 'Edit' ? selectedTableRow : null}
